...
<html>
               ...
               <h>留言列表</h>
                  <table>
                   ...
                   <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				    	<th><?php echo ($vo["fid"]); ?></th><th><?php echo (subtext(strip_tags($vo["fcontent"]),30)); ?></th><th><?php echo ($vo['ftime']); ?></th><th><a href="/blog/index.php/Admin/Feel/delete/id/<?php echo ($vo["aid"]); ?>" onclick="return confirm('确定要删除这篇文章吗?');">删除&nbsp;</a><a href="/blog/index.php/Admin/Feel/edit/id/<?php echo ($vo['aid']); ?>">编辑</a></th>
            ...
            <?php echo ($page); ?>
             ...
             <div class="parts">
              <div class="module-add">
                 <h>发表微语</h>
                 <form action="/blog/index.php/Admin/Feel/update" method="post"  id="module-form">
   ...
   var ue=UE.getEditor('editor');
    ue.ready(function() {
    	   ue.setContent('<?php echo ($arr['fcontent']); ?>');
    });
   </script>
    </body>
