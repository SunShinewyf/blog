           ...
           <div class="module-list">
             ...
             <div class="parts" style="width:492px;margin-left:10px">
              <div class="module-add">
                 ...
                 <form action="/blog/index.php/Admin/Module/add" method="post"  id="module-form">
                     ...
                     <select  class="box-control" id="parentid" name="parentid">
                         ...
                         <?php if(is_array($parent)): $i = 0; $__LIST__ = $parent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["mid"]); ?>"><?php echo ($vo['mname']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                      </select>
                      <label for="desc">*模块备注信息</label>
                      <input type="text" class="box-control" id="desc" name="desc" placeholder="填写模块备注信息" autocomplete="off"/></br>
